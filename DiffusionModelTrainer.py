...
class WechatDataset(Dataset):
    def __init__(self, json_path):
        ...
        # Simple normalization to [-1, 1] range based on data stats if needed
        # For diffusion, inputs are typically scaled to roughly unit variance or [-1, 1]
...
def train():
    ...
    print("Training complete. Model saved to diffusion_model.pth")
